  ...
  <div>
    <div class="container">
      <div class="handle-box">
        <el-select v-model="params.level" filterable clearable placeholder="菜单级别" class="handle-select mr10"
                   @change="query">
          <el-option label="模块" value="1"/>
          <el-option label="菜单" value="2"/>
          <el-option label="功能" value="3"/>
        </el-select>
        <el-select v-model="params.type" filterable clearable placeholder="菜单类型" class="handle-select mr10"
                   @change="query">
          <el-option label="pc" value="1"/>
          <el-option label="pda" value="2"/>
        </el-select>
        <el-input v-model="params.parentId" placeholder="父菜单id" class="handle-input mr10" @blur="query"></el-input>
